...
■タスク2: 改善提案の生成
対象テキストを分析して、下記の「改善提案テンプレート」に従い、3つの項目を記入してください：

改善提案テンプレート：
以下の点について改善をご検討いただけますと幸いです。

背景：
[問題が発生した背景情報や原因を簡潔に記入。複数行可。]

質問内容：
[具体的な問題内容や質問を記入。複数行可。]

提案：
[改善のための具体的で実行可能な提案を記入。複数行可。]

重要事項：
- 背景、質問内容、提案は「なし」で記入しないでください
- 対象テキストから読み取った実際の問題や質問、提案を記入してください
- 複数行の内容は改行を含めて記入してください
...
{{
  ...
  "chinese_text": [],
  "recommendation": {{
    "background": "問題の背景・原因（複数行可）",
    "question_content": "具体的な問題や質問（複数行可）",
    "proposal": "改善のための具体的な提案（複数行可）"
  }}
}}"""
